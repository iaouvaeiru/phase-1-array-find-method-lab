...
// const existence = (record, check) => {
//     let result = undefined
//     for(let value of Array.from(record)){
...
const arrayFind = (record) => {
    return record.result === "W"
}

function superbowlWin(array) {    
    let found = array.find(arrayFind)
...
//     for (const record of Array.from(array)) {
//         if (record.result === 'W'){
//             return record.year
//         }
//     }
...
// const checkWin = (req) => {
//     return req.year == checkRequirement
// }

// const superbowlWin = (array) => {
//      array.find(checkWin, array)
// }
